package me.icefire.common.snackbar;
 ...
 *date 2019/1/9
 */
public final class SnackBarCompat {

    private SnackBarCompat() {
    ...
    public static void showSnackBar(Activity activity, String text) {
        SnackBarCompat.builder()
                .setBackgroundColor(ContextCompat.getColor(activity, R.color.snackbar_bg))
                .setTextSize(14)
    ...
    public static void showSnackBar(Activity activity, String text, String action, View.OnClickListener listener) {
        SnackBarCompat.builder()
                ...
                .setActivity(activity)
                .setDuration(SnackBarCompat.DurationType.LENGTH_INDEFINITE)
                .build()
                .show();
    }
    ...
    private SnackBarCompat(Builder builder) {
    ...
    private Snackbar make() {
        ...
        //设置颜色，最大行数和位置属性
        if (builder.txtColors != null) {
            text.setTextColor(builder.txtColors);
        } else if (builder.txtColor != null) {
            text.setTextColor(builder.txtColor);
        }
    ...
    public static class Builder {
        ...
        private int txtResId = 0;
        private Integer txtColor = null;
        private ColorStateList txtColors = null;
        ...
        public Builder setActionTextTypeface(Typeface typeface) {
            this.actionTextTypeface = textTypeface;
            return this;
        }
        ...
        private Snackbar make() {
            if (view == null) {
                throw new IllegalStateException("must set an Activity or View before making a snack");
            }

            return new SnackBarCompat(this).make();
        }
    }
}
