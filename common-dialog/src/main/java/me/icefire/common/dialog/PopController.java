...
public class PopController {
    ...
    public PopController(PopDialog dialog, Window window) {
        mDialog = dialog;
        mWindow = window;
    }
    ...
    public static class AlertParams {
        ...
        public int mAnimation = R.style.PopDialogAnimation;
         ...
         * 设置参数
         */
        public void apply(PopController alert) {
            PDialogViewHelper viewHelper = null;
            // 1. 设置布局
            if (0 != mViewLayoutResId) {
                viewHelper = new PDialogViewHelper(mContext, mViewLayoutResId);
            }

            if (null != mView) {
                viewHelper = new PDialogViewHelper(mContext, mView);
            }
            ...
            viewHelper.setOnJAlertDialogClickListener(mOnPopDialogClickListener);
